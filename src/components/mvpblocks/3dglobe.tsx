...
export default function Globe3D() {
  return (
    ...
    >
      ...
      />
      <div
        className="-scale-x-100 absolute top-0 left-0 h-1/2 w-1/2"
        style={{
          background:
            "radial-gradient(circle at 70% 30%, rgba(155, 135, 245, 0.15) 0%, rgba(13, 10, 25, 0) 60%)",
        }}
      ...
      <div className="container relative z-10 mx-auto max-w-2xl px-4 text-center md:max-w-4xl md:px-6 lg:max-w-7xl">
        ...
        >
          <span className="mb-6 inline-block rounded-full border border-[#9b87f5]/30 px-3 py-1 text-[#9b87f5] text-xs">
          ...
          <div className="mb-10 flex flex-col items-center justify-center gap-4 sm:mb-0 sm:flex-row">
            <Link
              ...
              className="neumorphic-button 135, 245, 0.5)] relative w-full overflow-hidden rounded-full border border-white/10 bg-gradient-to-b from-white/10 to-white/5 px-8 py-4 text-white shadow-lg transition-all duration-300 hover:border-[#9b87f5]/30 hover:shadow-[0_0_20px_rgba(155, sm:w-auto"
            >
              Get Started
            </Link>
            <a
        ...
        >
          <div className="relative flex h-40 w-full overflow-hidden md:h-64">
            <img
              ...
              alt="Earth"
              className="-z-10 -translate-x-1/2 absolute top-0 left-1/2 mx-auto px-4 opacity-80"
            />
          </div>
