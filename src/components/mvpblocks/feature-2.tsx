      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="relative mx-auto mb-12 max-w-2xl sm:text-center">
          <div className="relative z-10">
            <h2 className="font-bold font-geist text-3xl tracking-tighter md:text-4xl lg:text-5xl">
        ...
        <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-10">
          <div className="order-2 space-y-8 md:order-1">
            {features.map((feature, index) => (
              <motion.div
                key={index}
                className="flex cursor-pointer items-start gap-6 md:gap-8"
                  ...
                  index === currentFeature && (
                    ...
                    >
                      <img
                        ...
                        height={500}
                      />
                      <div className="absolute right-0 bottom-0 left-0 h-2/3 bg-gradient-to-t from-background via-background/50 to-transparent" />
