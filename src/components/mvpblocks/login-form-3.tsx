          ...
          <div className="grid min-h-[700px] lg:grid-cols-2">
            ...
            <div className="brand-side relative m-4 rounded-3xl bg-[url('https://cdn.midjourney.com/299f94f9-ecb9-4b26-bead-010b8d8b01d9/0_0.png?w=800&q=80')] bg-cover p-12 text-white">
              <div>
                ...
                <h1 className="mb-4 font-medium text-6xl">
            ...
            <div className="flex flex-col justify-center p-12">
              <div className="mx-auto w-full max-w-md">
                <div className="mb-8 text-center">
                  <h2 className="font-light text-3xl uppercase">
                    Welcome back
                  </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      type="button"
                      className="flex items-center justify-center rounded-lg border border-border bg-secondary px-4 py-2.5 text-foreground text-sm shadow-sm hover:bg-secondary/80"
                    >
                      <img
