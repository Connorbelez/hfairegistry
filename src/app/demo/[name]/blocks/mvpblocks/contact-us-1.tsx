  ...
  return (
    <section className="relative w-full overflow-hidden bg-background py-16 md:py-24">
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, #e60a64, transparent 70%)",
        }}
      />
      <div
          ...
          <div className="grid md:grid-cols-2">
            ...
            >
              <div className="flex flex-col items-center justify-center overflow-hidden">
                <article className="relative mx-auto h-[350px] min-h-60 max-w-[450px] overflow-hidden rounded-3xl border bg-gradient-to-b from-[#e60a64] to-[#e60a64]/5 p-6 text-3xl text-white tracking-tight md:h-[450px] md:min-h-80 md:p-8 md:text-4xl md:leading-[1.05] lg:text-5xl">
                  Presenting you with the best UI possible.
                  <div className="-right-20 -bottom-20 md:-right-28 md:-bottom-28 absolute z-10 mx-auto flex h-full w-full max-w-[300px] items-center justify-center transition-all duration-700 hover:scale-105 md:max-w-[550px]">
                    <Earth
                      scale={1.1}
                      baseColor={[1, 0, 0.3]}
                      markerColor={[0, 0, 0]}
